...
class PositionsTest < ApplicationSystemTestCase
  ...
  test "creating a Position" do
    ...
    fill_in "Abbreviation", with: @position.abbreviation
    fill_in "Alternate names", with: @position.alternate_names
    fill_in "Name", with: @position.name
    fill_in "Role", with: @position.role
    fill_in "Standardized name", with: @position.standardized_name
