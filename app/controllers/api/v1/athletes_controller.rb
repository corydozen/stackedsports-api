class Api::V1::AthletesController < Api::ApiController
  ...
  private
    ...
    def athlete_params
      params.require(:athlete).permit(:first_name, :last_name, :phone, :email, :nick_name, :graduation_year, :high_school, :state, :coach_name, :mothers_name, :fathers_name, :hudl_id, :arms_id, :twitter_profile_id, :instagram_id, :team_id)
    end
end
