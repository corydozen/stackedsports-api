...
Rails.application.config.sorcery.submodules = %i[jwt user_activation reset_password session_timeout brute_force_protection activity_logging external magic_login remember_me]
...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  config.twitter.key = ENV['RS_TWITTER_API_KEY']
  config.twitter.secret = ENV['RS_TWITTER_API_SECRET']
  ...
  config.user_config do |user|
    ...
    # Default: `nil`
    #
    user.encryption_key = '5+@ck3d5p0r+5'
    ...
    # Default: `nil`
    #
    user.activation_token_expiration_period = 172_800 # 2 days
    ...
    # Default: `nil`
    #
    user.reset_password_expiration_period = 7200 # 2 hours
    ...
    # Default: `nil`
    #
    user.magic_login_expiration_period = 7200 # 2 hours
